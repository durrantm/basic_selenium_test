describe 'student loan products', order: :defined do
  ...
  describe "Dental and Medical Form", smoke: true, loan_type: 'dental_and_medical', page_type: 'form' do
    it "exists for following tests to use, otherwise they are skipped", loan_type: 'dental_and_medical' do
