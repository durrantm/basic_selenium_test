describe 'student loan products', order: :defined do
  ...
  describe "Career Training Form", smoke: true, loan_type: 'career_training', page_type: 'form' do
    it "exists for following tests to use, otherwise they are skipped", loan_type: 'career_training' do
