describe 'student loan products', order: :defined do
  ...
  describe "Undergraduate Form", smoke: true, loan_type: 'undergraduate', page_type: 'form' do
    it "exists for following tests to use, otherwise they are skipped", loan_type: 'undergraduate' do
      visit_url(TEST_ENVIRONMENT, p.undergraduate_loan_form_url, p.undergradudate_loan_form_id, p)
